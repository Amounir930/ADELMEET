...
| **LiveKit SFU Self-Hosted** | ❌ يستخدم Cloud حالياً | P2 — Medium |
...
#### 4.3 LiveKit Self-Hosted (Optional)
- [ ] نشر LiveKit SFU على Google Cloud (نفس السيرفر أو VM منفصل)
- [ ] تكوين `livekit.yaml` مع Redis
- [ ] ربط Domain: `livekit.60sec.shop`
- [ ] تحديث `.env` لاستخدام السيرفر الخاص
